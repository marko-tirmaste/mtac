 ...
 * Gets product by mtac product code.
 * 
 ...
 * @since 1.0.0 2023-05-15
 */
class ImportSingleEndpoint extends Endpoint implements EndpointContract
{
    /**
     * Endpoint arguments
     * 
    ...
    {
        vi()->make(StockController::class)->importStock((string) $request->get_param('id'));
    ...
    {
        return 'stock/(?P<id>[a-zA-Z0-9-]+)/import';
    }
}